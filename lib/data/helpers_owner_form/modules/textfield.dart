...
final TextEditingController boatNameController =
    TextEditingController(); //добавила контроллер для нового поля "название лодки"
    ...
    return Column(children: <Widget>[
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(5),
                        borderSide:
                            BorderSide(width: 2.5, color: activeButton)),
            ...
            Flexible(
              ...
              child: Form(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    bool mobileValid = RegExp(r'(^[0-9]*$)').hasMatch(value!);
                    if (!mobileValid) {
                      return 'Введите данные';
      ...
      Form(
        ...
        child: TextFormField(
          keyboardType: TextInputType.text,
          controller:
              boatNameController, // сделала новый контроллер "название лодки"
          cursorColor: activeButton,
          decoration: InputDecoration(
            border: InputBorder.none,
            errorStyle: TextStyle(
            ...
            focusedBorder: OutlineInputBorder(
                ...
                borderSide: BorderSide(width: 2.5, color: activeButton)),
            hintText: tr
                .modelHint, // необходим перевод поля "название лодки", чтобы вставить в эту строку
            hintStyle: TextStyle(fontSize: 17, color: hintTextColor),
            isDense: true,
          ),
          validator: (value) {
